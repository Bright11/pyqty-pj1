...
# fetch data from database
    ...
    def fetch_data(self):
            ...
            conn = sqlite3.connect(databasename)
            cur = conn.cursor()
            cur.execute("SELECT * FROM workers WHERE position='rider'" )
            rows = cur.fetchall()
            conn.close()
        #     return rows
        #     create tabel
...
# clear data
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "Rider"))
        ...
        self.label_8.setText(_translate("MainWindow", "Positioning of the rider already configured"))
